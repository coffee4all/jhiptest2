...
import ro.quador.bizplace.repository.AuthorityRepository;
...
public class UserService {
    ...
    public User createUserInformation(String login, String password, String firstName, String lastName, String email,
        ...
        newUser.setActivationKey(RandomUtil.generateRandomKey());
    ...
    public void updateUserInformation(String firstName, String lastName, String email, CompanieDTO companyDTO) {
        ...
        Companie companie = companieRepository.findOne(currentUser.getCompanies().toArray(new Companie[]{})[0].getId());
        companie.setNume(companyDTO.getNume());
        companie.setCui(companyDTO.getCui());
        companie.setAdresa(companyDTO.getAdresa());
        companie.setEmail(companyDTO.getEmail());
        companie.setWebsite(companyDTO.getWebsite());
        companie.setTelefon(companyDTO.getTelefon());
        companie.setActivitate(new Activitate(companyDTO.getActivitate()));
        companie.setJudet(new Judet(companyDTO.getJudet()));
    ...
    public User getUserWithAuthorities() {
        ...
        currentUser.getCompanies().size(); // eagerly load the association
        return currentUser;
    }
