...
var bizplaceApp = angular.module('bizplaceApp', ['http-auth-interceptor', 'tmh.dynamicLocale',
    'ngResource', 'ngRoute', 'ngCookies', 'bizplaceAppUtils', 'pascalprecht.translate', 'truncate']);
    ...
    .config(function ($routeProvider, $httpProvider, $translateProvider, tmhDynamicLocaleProvider, USER_ROLES) {
            $routeProvider
                ...
                .when('/pwdreset', {
                    ...
                    controller: 'PwdResetEmailController',
                    access: {
                        authorizedRoles: [USER_ROLES.all]
                    }
                })
                ...
                .when('/head_slider', {
                    templateUrl: 'views/head_slider.html',
                    access: {
                        authorizedRoles: [USER_ROLES.all]
                    }
                })
